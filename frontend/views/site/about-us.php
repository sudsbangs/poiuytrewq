...
<div class="page-content">
    ...
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <!-- Classic Heading -->
            <h4 class="classic-title"><span>Welcome To Our Residency</span></h4>
        ...
        <div class="col-md-5">
            ...
            <div class="touch-slider" data-slider-navigation="true" data-slider-pagination="true">
                <div class="item"><img alt="" src="<?= Yii::$app->request->baseUrl ?>/custom/images/about-01.jpg"></div>
                <div class="item"><img alt="" src="<?= Yii::$app->request->baseUrl ?>/custom/images/about-02.jpg"></div>
                <div class="item"><img alt="" src="<?= Yii::$app->request->baseUrl ?>/custom/images/about-03.jpg"></div>
            </div>
            <!-- End Touch Slider -->
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="team-member">
                ...
                <div class="member-photo">
                    <img alt="" src="<?= Yii::$app->request->baseUrl ?>/custom/images/team/face_1.png" />
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="team-member">
                <!-- Memebr Photo, Name & Position -->
                <div class="member-photo">
                    <img alt="" src="<?= Yii::$app->request->baseUrl ?>/custom/images/team/face_2.png" />
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="team-member">
                <!-- Memebr Photo, Name & Position -->
                <div class="member-photo">
                    <img alt="" src="<?= Yii::$app->request->baseUrl ?>/custom/images/team/face_3.png" />
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="team-member">
                <!-- Memebr Photo, Name & Position -->
                <div class="member-photo">
                    <img alt="" src="<?= Yii::$app->request->baseUrl ?>/custom/images/team/face_4.png" />
    ...
    <div class="our-clients">
        ...
        <div class="clients-carousel custom-carousel touch-carousel" data-appeared-items="5">
            ...
            <div class="client-item item">
                <a href="#"><img src="<?= Yii::$app->request->baseUrl ?>/custom/images/c1.png" alt="" /></a>
            </div>

            <!-- Client 2 -->
            <div class="client-item item">
                <a href="#"><img src="<?= Yii::$app->request->baseUrl ?>/custom/images/c2.png" alt="" /></a>
            </div>

            <!-- Client 3 -->
            <div class="client-item item">
                <a href="#"><img src="<?= Yii::$app->request->baseUrl ?>/custom/images/c3.png" alt="" /></a>
            </div>

            <!-- Client 4 -->
            <div class="client-item item">
                <a href="#"><img src="<?= Yii::$app->request->baseUrl ?>/custom/images/c4.png" alt="" /></a>
            </div>

            <!-- Client 5 -->
            <div class="client-item item">
                <a href="#"><img src="<?= Yii::$app->request->baseUrl ?>/custom/images/c5.png" alt="" /></a>
            </div>

            <!-- Client 6 -->
            <div class="client-item item">
                <a href="#"><img src="<?= Yii::$app->request->baseUrl ?>/custom/images/c6.png" alt="" /></a>
            </div>

            <!-- Client 7 -->
            <div class="client-item item">
                <a href="#"><img src="<?= Yii::$app->request->baseUrl ?>/custom/images/c7.png" alt="" /></a>
            </div>

            <!-- Client 8 -->
            <div class="client-item item">
                <a href="#"><img src="<?= Yii::$app->request->baseUrl ?>/custom/images/c8.png" alt="" /></a>
            </div>
